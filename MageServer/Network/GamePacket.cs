            ...
            public static class Study
            {
                ...
                public static MemoryStream SendCharacterInSlot(MageServer.Player player, Byte slot, DataTable data)
                {
                    ...
                    if (data.Rows.Count > 0)
                    {
                        ...
                        outStream.WriteByte(0x00); //outStream.WriteByte(charData.Field<Byte>("agility"));
                        outStream.WriteByte(0x00); //outStream.WriteByte(charData.Field<Byte>("constitution"));
                        outStream.WriteByte(0x00); //outStream.WriteByte(charData.Field<Byte>("memory"));
                        outStream.WriteByte(0x00); //outStream.WriteByte(charData.Field<Byte>("reasoning"));
                        outStream.WriteByte(0x00); //outStream.WriteByte(charData.Field<Byte>("discipline"));
                        outStream.WriteByte(0x00); //outStream.WriteByte(charData.Field<Byte>("empathy"));
                        outStream.WriteByte(0x00); //outStream.WriteByte(charData.Field<Byte>("intuition"));
                        outStream.WriteByte(0x00); //outStream.WriteByte(charData.Field<Byte>("presence"));
                        outStream.WriteByte(0x00); //outStream.WriteByte(charData.Field<Byte>("quickness"));
                        outStream.WriteByte(0x00); //outStream.WriteByte(charData.Field<Byte>("strength"));
                        outStream.WriteByte(0x00);
                        outStream.WriteByte(0x00);
                        outStream.WriteByte(0x00); //outStream.WriteByte(charData.Field<Byte>("agility"));
                        outStream.WriteByte(0x00); //outStream.WriteByte(charData.Field<Byte>("constitution"));
                        ...
                        outStream.WriteByte(0x00);
                        outStream.WriteByte(0x00);
                        outStream.WriteByte(0x00); //outStream.WriteByte(charData.Field<Byte>("list_1"));
                        outStream.WriteByte(0x00); //outStream.WriteByte(charData.Field<Byte>("list_2"));
                        outStream.WriteByte(0x00); //outStream.WriteByte(charData.Field<Byte>("list_3"));
                        outStream.WriteByte(0x00); //outStream.WriteByte(charData.Field<Byte>("list_4"));
                        outStream.WriteByte(0x00); //outStream.WriteByte(charData.Field<Byte>("list_5"));
                        outStream.WriteByte(0x00); //outStream.WriteByte(charData.Field<Byte>("list_6"));
                        outStream.WriteByte(0x00); //outStream.WriteByte(charData.Field<Byte>("list_7"));
                        outStream.WriteByte(0x00); //outStream.WriteByte(charData.Field<Byte>("list_8"));
                        outStream.WriteByte(0x00); //outStream.WriteByte(charData.Field<Byte>("list_9"));
                        outStream.WriteByte(0x00); //outStream.WriteByte(charData.Field<Byte>("list_10"));
                        outStream.WriteByte(0x00);
                        outStream.WriteByte(0x00);
                        outStream.WriteByte(0x00); //outStream.WriteByte(charData.Field<Byte>("list_level_1"));
                        outStream.WriteByte(0x00); //outStream.WriteByte(charData.Field<Byte>("list_level_2"));
                        outStream.WriteByte(0x00); //outStream.WriteByte(charData.Field<Byte>("list_level_3"));
                        outStream.WriteByte(0x00); //outStream.WriteByte(charData.Field<Byte>("list_level_4"));
                        outStream.WriteByte(0x00); //outStream.WriteByte(charData.Field<Byte>("list_level_5"));
                        outStream.WriteByte(0x00); //outStream.WriteByte(charData.Field<Byte>("list_level_6"));
                        outStream.WriteByte(0x00); //outStream.WriteByte(charData.Field<Byte>("list_level_7"));
                        outStream.WriteByte(0x00); //outStream.WriteByte(charData.Field<Byte>("list_level_8"));
                        outStream.WriteByte(0x00); //outStream.WriteByte(charData.Field<Byte>("list_level_9"));
                        outStream.WriteByte(0x00); //outStream.WriteByte(charData.Field<Byte>("list_level_10"));
                        outStream.WriteByte(0x00);
                        outStream.WriteByte(0x00);
                        outStream.WriteByte(0x00); //outStream.WriteByte(charData.Field<Byte>("class"));
                        outStream.WriteByte(0x00); //outStream.WriteByte(charData.Field<Byte>("level"));
                        outStream.WriteByte(0x00); //outStream.WriteByte(charData.Field<Byte>("spell_picks"));
                        outStream.WriteByte(0x00);
                        outStream.WriteByte(0x00); //outStream.WriteByte(charData.Field<Byte>("model"));
                        outStream.WriteByte(0x00);
                        outStream.WriteByte(0x00);
                        outStream.WriteByte(0x00);
                        //outStream.Write(BitConverter.GetBytes(NetHelper.FlipBytes((UInt32)(charData.Field<UInt64>("experience")))), 0, 4);
                        outStream.Write(BitConverter.GetBytes(NetHelper.FlipBytes((UInt32)(1))), 0, 4);

                        //byte[] kBuffer = BitConverter.GetBytes(NetHelper.FlipBytes(charData.Field<UInt16>("spell_key_1")));
                        byte[] kBuffer = BitConverter.GetBytes(NetHelper.FlipBytes(1));
                        outStream.Write(kBuffer, 0, 2);
                        //kBuffer = BitConverter.GetBytes(NetHelper.FlipBytes(charData.Field<UInt16>("spell_key_2")));
                        kBuffer = BitConverter.GetBytes(NetHelper.FlipBytes(1));
                        outStream.Write(kBuffer, 0, 2);
                        ...
                        outStream.WriteByte(0x00); //outStream.WriteByte(charData.Field<Byte>("oplevel"));
                        outStream.WriteByte(0x00); //outStream.WriteByte(charData.Field<Byte>("oplevel"));
                        outStream.WriteByte(0x00); //outStream.WriteByte(charData.Field<Byte>("oplevel"));
                        outStream.WriteByte(0x00); //outStream.WriteByte(charData.Field<Byte>("oplevel"));
                    }
