...
namespace MageServer
{
    public class Character
    {
        ...
        public Character(Player player, DataRow data)
        {
            ...
            Agility = (Byte)(0x00);// data.Field<Byte>("agility");
            Constitution = (Byte)(0x00);//data.Field<Byte>("constitution");
            Memory = (Byte)(0x00);//data.Field<Byte>("memory");
            Reasoning = (Byte)(0x00);//data.Field<Byte>("reasoning");
            Discipline = (Byte)(0x00);//data.Field<Byte>("discipline");
            Empathy = (Byte)(0x00);//data.Field<Byte>("empathy");
            Intuition = (Byte)(0x00);//data.Field<Byte>("intuition");
            Presence = (Byte)(0x00);//data.Field<Byte>("presence");
            Quickness = (Byte)(0x00);//data.Field<Byte>("quickness");
            Strength = (Byte)(0x00);//data.Field<Byte>("strength");
            SpentStatPoints = (UInt32)(0);// data.Field<UInt32>("spent_stat");
            BonusStatPoints = (UInt32)(0);//data.Field<UInt32>("bonus_stat");
            BonusStatPointsSpent = (UInt32)(0);//data.Field<UInt32>("bonus_spent");
            List1 = (Byte)(0x00);// data.Field<Byte>("list_1");
            List2 = (Byte)(0x00);//data.Field<Byte>("list_2");
            List3 = (Byte)(0x00);//data.Field<Byte>("list_3");
            List4 = (Byte)(0x00);//data.Field<Byte>("list_4");
            List5 = (Byte)(0x00);//data.Field<Byte>("list_5");
            List6 = (Byte)(0x00);//data.Field<Byte>("list_6");
            List7 = (Byte)(0x00);//data.Field<Byte>("list_7");
            List8 = (Byte)(0x00);//data.Field<Byte>("list_8");
            List9 = (Byte)(0x00);//data.Field<Byte>("list_9");
            List10 = (Byte)(0x00);//data.Field<Byte>("list_10");
            ListLevel1 = (Byte)(0x00);//data.Field<Byte>("list_level_1");
            ListLevel2 = (Byte)(0x00);//data.Field<Byte>("list_level_2");
            ListLevel3 = (Byte)(0x00);//data.Field<Byte>("list_level_3");
            ListLevel4 = (Byte)(0x00);//data.Field<Byte>("list_level_4");
            ListLevel5 = (Byte)(0x00);//data.Field<Byte>("list_level_5");
            ListLevel6 = (Byte)(0x00);//data.Field<Byte>("list_level_6");
            ListLevel7 = (Byte)(0x00);//data.Field<Byte>("list_level_7");
            ListLevel8 = (Byte)(0x00);//data.Field<Byte>("list_level_8");
            ListLevel9 = (Byte)(0x00);//data.Field<Byte>("list_level_9");
            ListLevel10 = (Byte)(0x00);//data.Field<Byte>("list_level_10");
            Class = PlayerClass.Arcanist;//(PlayerClass)data.Field<Byte>("class");
            Level = (Byte)(0x00);//data.Field<Byte>("level");
            SpellPicks = (Byte)(0x00);//data.Field<Byte>("spell_picks");
            Model = (Byte)(0x00);//data.Field<Byte>("model");
            Experience = (UInt64)(0);// data.Field<UInt64>("experience");
            SpellKey1 = (UInt16)(0);// data.Field<UInt16>("spell_key_1");
            SpellKey2 = (UInt16)(0);// data.Field<UInt16>("spell_key_2");
            SpellKey3 = (UInt16)(0);// data.Field<UInt16>("spell_key_3");
            SpellKey4 = (UInt16)(0);// data.Field<UInt16>("spell_key_4");
            SpellKey5 = (UInt16)(0);// data.Field<UInt16>("spell_key_5");
            SpellKey6 = (UInt16)(0);// data.Field<UInt16>("spell_key_6");
            SpellKey7 = (UInt16)(0);// data.Field<UInt16>("spell_key_7");
            SpellKey8 = (UInt16)(0);//  data.Field<UInt16>("spell_key_8");
            SpellKey9 = (UInt16)(0);// data.Field<UInt16>("spell_key_9");
            SpellKey10 = (UInt16)(0);// data.Field<UInt16>("spell_key_10");
            SpellKey11 = (UInt16)(0);// data.Field<UInt16>("spell_key_11");
            SpellKey12 = (UInt16)(0);// data.Field<UInt16>("spell_key_12");
            OpLevel = (Byte)(0);// data.Field<Byte>("oplevel");
            PlayerFlags = PlayerFlag.None;//(PlayerFlag)data.Field<UInt32>("flags");
